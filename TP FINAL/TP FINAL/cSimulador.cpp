...
cSimulador::cSimulador()
{
	...
	Porter->Procesos->AgregarItem(ProcesoPorter);
	ProcesoPorter = new cProceso(Porter->Insumos->BuscarItem("Malta de Trigo")->getCantidad(), 67, 90, Maceracion, Porter->Insumos->BuscarItem("Malta de Trigo"));
	Porter->Procesos->AgregarItem(ProcesoPorter);
	...
	Honey->Procesos->AgregarItem(ProcesoHoney);
	ProcesoHoney = new cProceso(Honey->Insumos->BuscarItem("Malta Biscuit")->getCantidad(), 65, 90, Maceracion, Honey->Insumos->BuscarItem("Malta Biscuit"));
	Honey->Procesos->AgregarItem(ProcesoHoney);
	...
	Irish_Red_Ale->Procesos->AgregarItem(ProcesoIrishRed);
	ProcesoIrishRed = new cProceso(Irish_Red_Ale->Insumos->BuscarItem("Malta Black")->getCantidad(), 67, 90, Maceracion, Irish_Red_Ale->Insumos->BuscarItem("Malta Black"));
	Irish_Red_Ale->Procesos->AgregarItem(ProcesoIrishRed);
	...
	IPA->Procesos->AgregarItem(ProcesoIpa);
	ProcesoIpa = new cProceso(4, 100, 5, Coccion, IPA->Insumos->BuscarItem("Lupulo Target"));
	IPA->Procesos->AgregarItem(ProcesoIpa);
	ProcesoIpa = new cProceso(4, 100, 10, Coccion, IPA->Insumos->BuscarItem("Lupulo Warrior"));
	IPA->Procesos->AgregarItem(ProcesoIpa);
	ProcesoIpa = new cProceso(4, 100, 10, Coccion, IPA->Insumos->BuscarItem("Lupulo Target"));
	IPA->Procesos->AgregarItem(ProcesoIpa);
	ProcesoIpa = new cProceso(4, 100, 5, Coccion, IPA->Insumos->BuscarItem("Lupulo Warrior"));
	IPA->Procesos->AgregarItem(ProcesoIpa);
	ProcesoIpa = new cProceso(4.5, 100, 15, Coccion, IPA->Insumos->BuscarItem("Lupulo Simcoe"));
	IPA->Procesos->AgregarItem(ProcesoIpa);
	ProcesoIpa = new cProceso(4, 100, 5, Coccion, IPA->Insumos->BuscarItem("Lupulo Simcoe"));
	IPA->Procesos->AgregarItem(ProcesoIpa);
	ProcesoIpa = new cProceso(4, 100, 10, Coccion, IPA->Insumos->BuscarItem("Lupulo Saaz"));
	IPA->Procesos->AgregarItem(ProcesoIpa);
	...
	Rubia->Procesos->AgregarItem(ProcesoRubia);
	ProcesoRubia = new cProceso(Rubia->Insumos->BuscarItem("Irish Moss")->getCantidad(), 100, 5, Coccion, Rubia->Insumos->BuscarItem("Irish Moss"));
	Rubia->Procesos->AgregarItem(ProcesoRubia);
